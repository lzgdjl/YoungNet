...
//	extern LogLevel g_LogLevel;
	...
	#define LOG_NOTICE_WRITE(fmt, ...) if(GetLogLevel() <= LogLevel::NOTICE) \
		fprintf(stderr, "[NOTICE][%s:%d][%d]" fmt "\n", __FILE__, __LINE__, Thread::GetTid(), ##__VA_ARGS__)
